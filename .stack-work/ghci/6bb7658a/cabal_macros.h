...
/* package projetoPFAzul-0.1.0.0 */
#ifndef VERSION_projetoPFAzul
#define VERSION_projetoPFAzul "0.1.0.0"
#endif /* VERSION_projetoPFAzul */
#ifndef MIN_VERSION_projetoPFAzul
#define MIN_VERSION_projetoPFAzul(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projetoPFAzul */
...
#define CURRENT_COMPONENT_ID "projetoPFAzul-0.1.0.0-IbPljHuVDFwHn77xMn9EaA-projetoPFAzul"
