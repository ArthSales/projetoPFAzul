...
-- >>> execState nextRound (State2 [(20,Azul),(20,Amarelo),(20,Vermelho),(10,Preto),(10,Branco)]  [] [] 0 [] [] [] [] [[(Azul,False),(Azul,True),(Azul,True)],[(Azul,False),(Azul,True),(Azul,True)],[(Azul,True),(Azul,True),(Azul,True)]] [] (0,0) [])
-- State2 {sa = [(18,Azul),(9,Amarelo),(15,Vermelho),(10,Preto),(8,Branco)], expositores = [[Azul,Branco,Amarelo,Vermelho],[Amarelo,Branco,Amarelo,Vermelho],[Amarelo,Amarelo,Amarelo,Vermelho],[Amarelo,Amarelo,Amarelo,Vermelho],[Amarelo,Azul,Amarelo,Vermelho]], cm = [], deQuemEAVez = 0, chao1 = [], chao2 = [], pl1 = [], pl2 = [], parede1 = [], parede2 = [], pontuacoes = (0,0), inputs = ""}
